...
//    private var lastFpsUpdate = 0L  // For throttling updates
//
//    // Temporary save flag for exporting sample frame
//    private var shouldSaveFrame = false  // Flag for one-time save
//
//    companion object {
//        private const val TAG = "EdgeDetection"
//        private const val CAMERA_PERMISSION_CODE = 100
...
//        container.addView(toggleButton)
//
//        // Temporary Save Frame button (top-right, for one-time export)
//        val saveButton = Button(this).apply {
//            text = "Save Frame"
//            setOnClickListener {
//                shouldSaveFrame = true  // Set flag; saves next processed frame
//                Log.d(TAG, "Save flag set—next EDGE frame will be exported")
//                // Optional: Disable after click to prevent multiples
//                isEnabled = false
//            }
//            layoutParams = FrameLayout.LayoutParams(
//                FrameLayout.LayoutParams.WRAP_CONTENT,
...
//                output.setPixels(result, 0, w, 0, 0, w, h)
//
//                // Temporary: Save frame to gallery if flag set
//                if (shouldSaveFrame) {
//                    try {
//                        val file = java.io.File("/sdcard/edge_sample.png")
//                        val outputStream = FileOutputStream(file)
//                        output.compress(Bitmap.CompressFormat.PNG, 100, outputStream)
//                        outputStream.flush()
//                        outputStream.close()
//                        Log.d(TAG, "✓ Sample edge frame saved to /sdcard/edge_sample.png (${w}x${h})")
//                        shouldSaveFrame = false  // Reset flag after one save
//                    } catch (e: Exception) {
